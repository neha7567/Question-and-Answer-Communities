...
final_results_dict_list = ['C://Users//Neha Sharma//Google Drive//Numerical_study_QA//'
                           'Results_simulation//aggregated_output_for_dist0.pkl']
...
if __name__ == '__main__':
    ...
    pool.starmap_async(gen_plots.generate_plots_with_c_q_r_q,
                       [(dicts_needed_list[num], main_file.c_q_vector, main_file.reward_q_vec, '2') for num in
                        range(num_files)]).get()
    pool.close()
